...
<body id="top">
	...
	<div class="navbar">
		<?php echo anchor('index.php/User/home', 'Home')
		?>
		<div class="dropdown">
	...
	<div class="line">
		<img src="http://cdn.persona5.jp/resources/img/top/line.png?v=1501756323862" width="1512" height="2500" alt="背景" class="image-loaded" style="margin-top: -120px">
		</div>
	<div class="shadow">
        <img src="http://cdn.persona5.jp/resources/img/top/about_p5_s.svg?v=1501756323862" width="1120" height="627" alt="Persona5is？" class="about-p5s image-loaded">
        <img src="http://cdn.persona5.jp/resources/img/top/school_life_s.svg?v=1501756323862" width="1049" height="604" alt="Tokyo School Life" class="school-lifes image-loaded">
    </div>
	...
	<div class="scene1">
        <div class="about-p5 right-left-up">
        	<img src="http://cdn.persona5.jp/resources/img/top/about_p5.png?v=1501756323862" width="1113" height="627" alt="Persona5is？" class="image-loaded">
	        <img src="https://s28.postimg.org/4m287tk0d/section_2_title.png" class="whatis image-loaded" width="400" height="185" alt="Persona5is？">
    ...
    <div class="scene2">
        <div class="school-life right-left-up run">
        	<img src="http://cdn.persona5.jp/resources/img/top/school_life.png?v=1501756323862" width="1049" height="604" alt="大都会東京で始まる最高に楽しい学園ライフ！" class="image-loaded">
            <p class="text">
